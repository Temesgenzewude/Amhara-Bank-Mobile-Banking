...
class AppDimension {
  ...
  static double height22 = screenHeight / (myDeviceHeight / 22);

  static double height24 = screenHeight / (myDeviceHeight / 24);
  static double height25 = screenHeight / (myDeviceHeight / 25);
  static double height26 = screenHeight / (myDeviceHeight / 26);
  static double height28 = screenHeight / (myDeviceHeight / 28);
  static double height29 = screenHeight / (myDeviceHeight / 29);

  static double height30 = screenHeight / (myDeviceHeight / 30);
  static double height35 = screenHeight / (myDeviceHeight / 35);
  static double height36 = screenHeight / (myDeviceHeight / 36);

  static double height38 = screenHeight / (myDeviceHeight / 38);
  ...
  static double height42 = screenHeight / (myDeviceHeight / 42);

  static double height44 = screenHeight / (myDeviceHeight / 44);
  static double height43 = screenHeight / (myDeviceHeight / 43);

  static double height47 = screenHeight / (myDeviceHeight / 47);
  static double height54 = screenHeight / (myDeviceHeight / 54);
  static double height56 = screenHeight / (myDeviceHeight / 56);

  static double height57 = screenHeight / (myDeviceHeight / 57);

  static double height68 = screenHeight / (myDeviceHeight / 68);
  static double height65 = screenHeight / (myDeviceHeight / 65);

  static double height69 = screenHeight / (myDeviceHeight / 69);
  static double height78 = screenHeight / (myDeviceHeight / 78);

  static double height83 = screenHeight / (myDeviceHeight / 83);

  static double height96 = screenHeight / (myDeviceHeight / 96);
  static double height103 = screenHeight / (myDeviceHeight / 103);

  static double height106 = screenHeight / (myDeviceHeight / 106);
  static double height123 = screenHeight / (myDeviceHeight / 123);

  static double height131 = screenHeight / (myDeviceHeight / 131);

  static double height136 = screenHeight / (myDeviceHeight / 136);
  static double height141 = screenHeight / (myDeviceHeight / 141);
  static double height150 = screenHeight / (myDeviceHeight / 150);
  static double height154 = screenHeight / (myDeviceHeight / 154);

  static double height169 = screenHeight / (myDeviceHeight / 169);

  static double height172 = screenHeight / (myDeviceHeight / 172);
  static double height181 = screenHeight / (myDeviceHeight / 181);
  static double height190 = screenHeight / (myDeviceHeight / 190);

  static double height216 = screenHeight / (myDeviceHeight / 216);
  static double height228 = screenHeight / (myDeviceHeight / 228);

  static double height272 = screenHeight / (myDeviceHeight / 272);
  static double height356 = screenHeight / (myDeviceHeight / 356);

  static double height716 = screenHeight / (myDeviceHeight / 716);
  static double height483 = screenHeight / (myDeviceHeight / 483);
  static double height546 = screenHeight / (myDeviceHeight / 546);

  static double height423 = screenHeight / (myDeviceHeight / 423);
  static double height338 = screenHeight / (myDeviceHeight / 338);
  static double height200 = screenHeight / (myDeviceHeight / 200);
  ...
  static double width16 = screenWidth / (myDeviceWidth / 16);
  static double width17 = screenWidth / (myDeviceWidth / 17);

  static double width20 = screenWidth / (myDeviceWidth / 20);
  static double width21 = screenWidth / (myDeviceWidth / 21);
  static double width24 = screenWidth / (myDeviceWidth / 24);
  static double width25 = screenWidth / (myDeviceWidth / 25);
  static double width29 = screenWidth / (myDeviceWidth / 29);

  static double width30 = screenWidth / (myDeviceWidth / 30);
  static double width40 = screenWidth / (myDeviceWidth / 40);
  static double width43 = screenWidth / (myDeviceWidth / 43);
  static double width36 = screenWidth / (myDeviceWidth / 36);
  static double width53 = screenWidth / (myDeviceWidth / 53);

  static double width63 = screenWidth / (myDeviceWidth / 63);

  static double width60 = screenWidth / (myDeviceWidth / 60);
  static double width66 = screenWidth / (myDeviceWidth / 66);
  ...
  static double width140 = screenWidth / (myDeviceWidth / 140);
  static double width150 = screenWidth / (myDeviceWidth / 150);
  static double width191 = screenWidth / (myDeviceWidth / 191);

  static double width238 = screenWidth / (myDeviceWidth / 238);
  static double width232 = screenWidth / (myDeviceWidth / 232);
  static double width252 = screenWidth / (myDeviceWidth / 252);

  static double width253 = screenWidth / (myDeviceWidth / 253);
  static double width265 = screenWidth / (myDeviceWidth / 265);

  static double width45 = screenWidth / (myDeviceWidth / 45);
  static double width341 = screenHeight / (myDeviceWidth / 341);
  static double width195 = screenHeight / (myDeviceWidth / 195);

  static double width352 = screenHeight / (myDeviceWidth / 352);
  static double width26 = screenHeight / (myDeviceWidth / 26);
  static double width139 = screenHeight / (myDeviceWidth / 139);
  static double width160 = screenHeight / (myDeviceWidth / 160);
  static double width196 = screenWidth / (myDeviceWidth / 196);
  static double width270 = screenWidth / (myDeviceWidth / 270);

  static double width302 = screenHeight / (myDeviceWidth / 302);
  static double width320 = screenHeight / (myDeviceWidth / 320);

  static double width329 = screenHeight / (myDeviceWidth / 329);
  ...
  static double font14 = screenHeight / (myDeviceHeight / 14);
  static double font16 = screenHeight / (myDeviceHeight / 16);

  static double font15 = screenHeight / (myDeviceHeight / 15);
  static double font17 = screenHeight / (myDeviceHeight / 17);
  ...
  static double font28 = screenHeight / (myDeviceHeight / 28);
  ...
  static double iconSize28 = screenHeight / (myDeviceHeight / 28);
