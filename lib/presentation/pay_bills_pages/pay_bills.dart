...
class _PayBillsState extends State<PayBills> {
  ...
  void _scrollToContainer(int index) {
    num offset = index * AppDimension.height123 +
        AppDimension.height10 +
        AppDimension.height3;
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                  height: _showAll ? AppDimension.height181+AppDimension.height100:AppDimension.height181,
                  width: AppDimension.width368,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              padding: EdgeInsets.only(
                                  left:
                                      AppDimension.width10 + AppDimension.width3),
                              child: GestureDetector(
                                onTap: () =>
                                    Get.toNamed(RouteHelper.ethioTellPayBills),
                                child: Column(
